...
import jesusUrl from '../assets/howie-jesus.jpg';
import getOutUrl from '../assets/get-out.gif';
...
// Howie at the gates. The real artwork, full bleed — the scene's light,
// clouds and gates are in the photograph itself, so the finale does not
// draw any of its own behind it.
export function HowieJesus() {
  return (
    <figure className="hj">
      <img className="hj-real" src={jesusUrl} alt="Howie at the gates" draggable={false} />
    </figure>
  );
}

// The "Get out." reaction shot — the real clip, caption and all.
export function HowDareYou() {
  return (
    <div className="hdy">
      <div className="hdy-frame">
        <img className="hdy-real" src={getOutUrl} alt="Get out." draggable={false} />
