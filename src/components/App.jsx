...
import T4Bag from './trials/T4Bag.jsx';
import T5Key from './trials/T5Key.jsx';
import T6ClockOut from './trials/T6ClockOut.jsx';

const TRIAL_VIEWS = { 1: T1Slot, 2: T2Pizza, 3: T3Darts, 4: T4Bag, 5: T5Key, 6: T6ClockOut };
